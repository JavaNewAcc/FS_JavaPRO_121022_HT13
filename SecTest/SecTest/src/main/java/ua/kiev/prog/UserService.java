...
public class UserService {
    ...
    @Transactional(readOnly = true)
    public List<CustomUser> getAllByID(List<Long> ids) {
        return (List<CustomUser>) userRepository.findAllById(ids);
    }
    ...
    @Transactional
    public boolean addUser(String login, String passHash, UserRole role, String email, String phone, String address) {
